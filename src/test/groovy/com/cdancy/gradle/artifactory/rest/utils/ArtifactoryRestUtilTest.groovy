...
import com.cdancy.gradle.artifactory.rest.utils.ArtifactoryRestUtil;

import groovy.transform.EqualsAndHashCode
import spock.lang.Specification

class ArtifactoryRestUtilTest extends Specification {
    def "can convert null list of Strings into array of Strings"() {
        given:
        List<String> strList = null

        when:
        String[] strArray = ArtifactoryRestUtil.toArray(strList)
    ...
    def "can convert list of POJOs into array of POJOs"() {
        ...
        when:
        Person[] personArray = ArtifactoryRestUtil.toArray(personList)
